...
import { twoFactorLoginSchema } from "../../schemas/auth/twoFactorLogin";
...
userAuthRouter.post(
  "/twoFactorLogin",
  joiCatchAsync(validate(twoFactorLoginSchema)),
  catchAsync(new UserAuthController().twoFactorLogin)
);
